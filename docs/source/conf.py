...
# -*- coding: utf-8 -*-
#
# pdbstore documentation build configuration file, created by
...
project = "pdbstore"
copyright = pdbstore.__copyright__
...
man_pages = [
    (
        "index",
        "pdbstore",
        "command interface to the pdbstore Package",
        [],
        1,
    )
]
